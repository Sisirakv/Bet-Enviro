    ...
    (i.VERSION = "3.2.0"),
        (i.prototype.close = function (e) {
            ...
            e && e.preventDefault(),
                ...
                e.isDefaultPrevented() || (s.removeClass("in"), t.support.transition && s.hasClass("sppb-fade") ? s.one("bsTransitionEnd", a).emulateTransitionEnd(150) : a());
        });
    var n = t.fn.spbalert;
                            ...
                            return (
                                ...
                                n.message
                                    ? i
                                          ...
                                          .html('<p class="sppb-alert sppb-alert-warning">' + n.message + "</p>")
                                          .fadeIn()
                                          .delay(4e3)
                                          .fadeOut(1e3)
                                    : n.messages &&
                                      i
                                          .next(".sppb-optin-form-status")
                                          .html('<p class="sppb-alert sppb-alert-warning">' + n.messages + "</p>")
                                          .fadeIn()
                                          .delay(4e3)
                                          .fadeOut(1e3),
                                !1
    ...
    (function (t) {
        (t.fn.basictable = function (e) {
            ...
            (t.fn.pageMe = function (e) {
                var i = t.extend({ perPage: 10, showPrevNext: !1, nextText: "Next", prevText: "Prev", hidePageNumbers: !1 }, e),
                    n = this.find("tbody"),
                    s = i.perPage,
                ...
                this.next().length &&
                    ...
                    r.data("curr", 0),
                    i.showPrevNext && t('<li class="sppb-page-item"><a href="#" class="sppb-table-prev-link sppb-page-link" title="' + i.prevText + '"><i aria-hidden="true" class="fa fa-angle-left"></i></a></li>').appendTo(r);
                ...
                function h(t) {
                    ...
                    o.css("display", "none").slice(e, i).show(),
                        t >= 1 ? r.find(".sppb-table-prev-link").show() : r.find(".sppb-table-prev-link").hide(),
                        t < p - 1 ? r.find(".sppb-table-next-link").show() : r.find(".sppb-table-next-link").hide(),
                        r.data("curr", t),
                ...
                i.showPrevNext && t('<li class="sppb-page-item"><a href="#" class="sppb-table-next-link sppb-page-link"  title="' + i.nextText + '"><i aria-hidden="true" class="fa fa-angle-right"></i></a></li>').appendTo(r),
    ...
    window.addEventListener("DOMContentLoaded", function () {
        ...
        function i(t, i) {
            t.forEach(function (t) {
                ...
                t.intersectionRatio &&
                    (("IMG" !== n.tagName && "IFRAME" !== n.tagName) || (n.src = n.dataset.large),
                    n.classList.contains("sppb-element-lazy") && n.classList.add("sppb-element-loaded"),
                    "VIDEO" === n.tagName && e(n),
                    null !== s && e(s),
        ...
        if (t.length > 0) {
            !(function () {
                if ("IntersectionObserver" in window) {
                    var e = new IntersectionObserver(i, { root: null, rootMargin: "0px", threshold: 0.1 });
                    t.forEach(function (t) {
                        e.observe(t);
                    });
                } else
                        ...
                        },
                        {
                            ...
                            value: function () {
                                (this.event = { clientX: this.left + this.width / 2, clientY: this.top + this.height / 2 }),
                                    null !== this.element.parentElement && "sppb-addon-wrapper" === this.element.parentElement.className && (this.element = this.element.parentElement),
                                    (this.element && "sppb-addon-wrapper" !== this.element.className) ||
